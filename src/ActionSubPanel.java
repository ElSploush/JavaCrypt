...
public class ActionSubPanel extends JPanel
{
	...
	public ActionSubPanel(JavaCrypt givenGame) // Create ActionSubPanel with a game
	{
		...
		buttonArray[0].setIcon(new ImageIcon("attack.png")); // Set image icon
		buttonArray[0].setRolloverIcon(new ImageIcon("attack.gif")); // Set rollover icon
		...
		buttonArray[1].setIcon(new ImageIcon("heal.png"));
		buttonArray[1].setRolloverIcon(new ImageIcon("heal.gif")); // Set rollover icon
		...
		buttonArray[2].setIcon(new ImageIcon("flee.png"));
		buttonArray[2].setRolloverIcon(new ImageIcon("flee.gif")); // Set rollover icon
